...
const TIER_MIN = -5;
const TIER_WEIGHT = 2;
const COUNTER_WEIGHT = 4 / 5; //Divided by 5 enemy heroes
const MIN_COUNTER_VALUE = 20;
const SINERGY_WEIGHT = 6 / 4; //Divided by 4 allied heroes, but with double weight than counters.
const MIN_SINERGY_VALUE = 20;
const MAPAD_WEIGHT = 10; //MapAD only gives weight to maps now, because ADC is deprecated.
