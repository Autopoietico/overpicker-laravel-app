...
<header class="relative mt-4 grid gap-y-5 justify-items-center sm:grid-cols-2">
    ...
    <nav class="invisible opacity-0 fixed -top-1 bg-[#294452]/95 z-0 w-full py-8 rounded-b-lg transition-opacity ease-in-out duration-300 sm:visible sm:static sm:bg-inherit sm:col-span-2 sm:border-t-2 sm:py-3 sm:opacity-100"
        id="header-nav">
        <ol
