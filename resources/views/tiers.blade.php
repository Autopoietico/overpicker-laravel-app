...
@section('content')
    ...
    <section class="mb-10 text-center sm:text-left text-sm max-w-4xl m-auto">
        <div class="mt-6 pb-2 border-b-2 border-dashed sm:mt-8">
            <p class="sm:text-lg">
                The tiers system allows the calculator to quickly pick heroes according to their performance in the last
                weeks, the tiers presented here are based on the heroes that are currently in the <b>Top500 leaderboard</b>
                in Overwatch 2, but the calculator has other types of tiers that may be more convenient for you!
            </p>
        </div>
                                ...
                                <tr class="odd:bg-[#294452]">
                                    <td>
                                        <div class="flex flex-col items-center m-1">
                                            <img src="{{ isset($hero['img']) ? $hero['img'] : 'images/assets/blank-hero.webp' }}"
                                    ...
                                    <td class="border-x-2 hidden sm:table-cell">
                                        <div class="flex flex-col items-center m-1">
                                            ...
                                            <h4 class="text-base abel font-medium w-14 truncate sm:w-20 sm:text-clip">Tank
                                            </h4>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="odd:bg-[#294452]">
                                    ...
                                    <td class="border-x-2 hidden sm:table-cell">
                                        <div class="flex flex-col items-center m-1">
                                            ...
                                            <h4 class="text-base abel font-medium w-14 truncate sm:w-20 sm:text-clip">Damage
                                            </h4>
                                        </div>
                                    </td>
                                    <td>
                        ...
                        @foreach ($tiers as $hero)
                            @if ($hero['value'] == $tier[0] && $hero['role'] == 'Support')
                                <tr class="odd:bg-[#294452]">
                                    ...
                                    <td class="border-x-2 hidden sm:table-cell">
                                        <div class="flex flex-col items-center m-1">
                                            <img src="\images\assets\support.webp" alt="Support Icon"
